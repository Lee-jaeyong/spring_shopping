...
<body>
	...
	<div class="site-wrap">
		...
		<div class="site-blocks-cover"
			style="background-image: url(${pageContext.request.contextPath}/resources/front/images/hero_1.jpg);" data-aos="fade">
			<div class="container">
				<div
					...
					<div class="col-md-12">
						<div class="nonloop-block-3 owl-carousel">
							...
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img src="${pageContext.request.contextPath}/resources/front/images/shoe_1.jpg" alt="Image placeholder"
											class="img-fluid">
									</figure>
									<div class="block-4-text p-4">
										<h3>
							...
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img src="${pageContext.request.contextPath}/resources/front/images/cloth_2.jpg" alt="Image placeholder"
											class="img-fluid">
									</figure>
									<div class="block-4-text p-4">
										<h3>
							...
							<div class="item">
								<div class="block-4 text-center">
									<figure class="block-4-image">
										<img src="${pageContext.request.contextPath}/resources/front/images/cloth_3.jpg" alt="Image placeholder"
											class="img-fluid">
									</figure>
									<div class="block-4-text p-4">
										<h3>
			...
			<div class="container">
				...
				<div class="row align-items-center">
					<div class="col-md-12 col-lg-7 mb-5">
						<a href="#"><img src="${pageContext.request.contextPath}/resources/front/images/blog_1.jpg"
